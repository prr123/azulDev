...
func buildPage(sit azulStruct)(js bytes.Buffer, err error) {
	...
	render() {azul.SPA = azul.addElement(this.divSPAObj);},
};
`
	js.WriteString(lpg)

	js.WriteString("azul.SPA.lpg.render();\n")
...
func buildNav(sit azulStruct, js *bytes.Buffer)(err error) {
    ...
    render() {
		azul.Nav = azul.addElement(azul.SPA.nav.divNavObj);
...
`
	...
	js.WriteString("azul.SPA.nav.render();\n")
...
func buildMain(sit azulStruct, js *bytes.Buffer)(err error) {
    ...
    render() {
		azul.Main = azul.addElement(azul.SPA.main.divMainObj);
...
`
	...
	js.WriteString("azul.SPA.main.render();\n")
...
func buildFoot(sit azulStruct, js *bytes.Buffer)(err error) {
    ...
    render() {
		azul.Foot = azul.addElement(azul.SPA.foot.divFootObj);
...
`
	...
	js.WriteString("azul.SPA.foot.render();\n")
